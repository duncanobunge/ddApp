                        ...
                        @endif
                            <div class="form-group">
                               <div class="form-group row">
                                   ...
                                   <div class="col-sm-10">
                                    <input type="text" name="symptom_id"  class="form-control" id="staticEmail" >
                                   </div>
                                </div>
                                <div class="form-group row">
                                   <label for="staticEmail" class="col-lg-2 control-label">Symptom(s)</label>
                                   <div class="col-sm-10">
                                    <input type="text" name="symptoms"  class="form-control" id="staticEmail" >
                                   </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <button type="submit" class="btn btn-primary">Diagonise</button>
                        </fieldset>
                            </form>
                        </div>
